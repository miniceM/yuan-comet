...
- **Pull request revision push, evidence refresh, and replacement**: Support pushing new verified commits to open PRs, refresh their body with final verification and review evidence through recoverable update operations, and allow creating replacement PRs after a prior PR is closed-unmerged.
