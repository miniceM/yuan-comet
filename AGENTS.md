...
- `domains/`：业务领域模块。每个子目录是一个可独立维护的领域模块，例如 `domains/agent-learning/`、`domains/bundle/`、`domains/code-intelligence/`、`domains/comet-classic/`、`domains/comet-native/`、`domains/comet-entry/`、`domains/dashboard/`、`domains/project-knowledge/`、`domains/skill/`、`domains/workflow-contract/`。
